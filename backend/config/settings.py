...
# Database
# Use dj_database_url to parse the DATABASE_URL from the environment
DATABASES = {
...
# drf_yasg settings for Swagger UI authentication
SWAGGER_SETTINGS = {
...
if not DEBUG:
    ...
    # Session cookies will only be sent over a secure HTTPS connection
    SESSION_COOKIE_SECURE = True
    # CSRF cookies will only be sent over a secure HTTPS connection
    CSRF_COOKIE_SECURE = True
    # HSTS tells browsers to only use HTTPS for your domain
    SECURE_HSTS_SECONDS = 31536000  # For one year
    SECURE_HSTS_INCLUDE_SUBDOMAINS = True
    SECURE_HSTS_PRELOAD = True
    # Tells Django that it's behind a proxy that's handling the SSL
